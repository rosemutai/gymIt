...
const Services = () => {
  return (
    <div
      id="ourservices"
      className="services-cards md:w-full md:flex md:flex-col md:px-24 md:pb-16 bg-slate-100 bgred-500"
    >
      ...
      <div className="cards flex flex-col md:flex-row justify-between px-6">
        <div
          className="card bgorangish w-72 h-56 px-1 mx-auto md:ml-0 md:mr-2 pt-3 border flex 
        ...
        >
          ...
          <h4
            className="card-title text-orangish font-roboto text-center
                    font-bold tracking-widest text-[0.8rem] mt-3"
          >
            PERSONAL TRAINING
          </h4>
          <p className="md:w-full text-center mx-auto text-tail-blue  text-xs">
        ...
        <div
          className="card bgorangish w-72 h-56 px-2 mx-auto md:ml-0 md:mr-2 border flex 
