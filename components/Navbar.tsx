  ...
  return (
    <div className="w-full md:px-24 md:pt-12 md:flex md:justify-between overflowhidden ">
      <div className="logo-section flex justify-between">
        <div className="logo m-2 md:m-0 text-orangish font-roboto font-bold tracking-wider">
          gym
      ...
      >
        <div
          className="md:hidden links-section flex flex-col md:flex-row justify-between items-center w-full h-44 
                relative bg-orangish"
        >
          <Link href="/">
            <a
              className="menu-link  z-20
