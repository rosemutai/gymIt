...
const membership = () => {
  return (
    <div className='w-full min-h-screen bg-tail-blue md:p-10 flex  justify-center items-center'>
             ...
             <div className='right-side rounded-l-md md:rounded-l-none rounded-r-md form bg-slate-100 md:w-1/2 md:px-3 mb-16 md:mb-0'>
                <div className='title'>
                    <h1 className="train text-tail-blue text-xl md:text-xl font-roboto 
                        font-bold py-4 md:py-0 my-3 text-center">Become A Member Today
                    </h1>
                ...
                <form className='membership-form md:flex md:flex-col md:justify-between mt-3 pb-8'>
                    <div className="email flex flex-col w-10/12 mx-auto mt-3">
                        ...
                        <input type="email" className='rounded-md bg-orangish/70 focus:outline-0
                            placeholder:text-slate-50 text-slate-100 placeholder:text-xsm p-2'
                            placeholder='&#x2709; pllumumba@gmail.com'></input>
                    </div>

                     <div className="password flex flex-col w-10/12 mx-auto mt-3">
                        <label className='text-tail-blue text-xs'>Password</label>
                        <input type="password" className='rounded-md bg-orangish/70 focus:outline-0
