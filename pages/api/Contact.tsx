...
const Contact = () => {
  ...
  return (
    <div id="contactus" className="w-full">
      ...
      <form
        className="membership-form bg-slate-100  w-11/12 md:w-1/2 mx-auto md:flex md:flex-col md:justify-between mt-3 pb-8"
      >
        ...
        <div className="btn w-full flex justify-center mt-3">
          <button
            ...
            bg-orangish text-xsm font-semibold tracking-wider py-4 px-2 hover:shadow-md
